...
async def get_dividend_info_async(session, ticker, current_price, manual_data):
    ...
    if dist_ttm_count > 0:
        ...
        if current_price > 0:
            dist_ttm_yield = round(calc_base_amount / current_price * 100.0, 4)
    ...
    if dist_ttm_count == 0 and dist_recent > 0 and dist_freq_1y > 0 and current_price > 0:
        est_annual_amount = dist_recent * dist_freq_1y
        est_annual_yield = round(est_annual_amount / current_price * 100.0, 4)
